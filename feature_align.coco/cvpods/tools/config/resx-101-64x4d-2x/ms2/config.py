...
_config_dict = dict(
    ...
    DATASETS=dict(
        ...
        TEST=("coco_2017_test-dev",), # coco_2017_val coco_2017_test-dev
    ),
    SOLVER=dict(
        IMS_PER_BATCH=16,
        IMS_PER_DEVICE=4,
    ...
    #480, 512, 544, 576, 608, 640, 672, 704, 736, 768, 800, 832, 864, 896, 928, 960
        ...
        AUG=dict(
            TRAIN_PIPELINES=[
                ("ResizeShortestEdge", dict(
                    short_edge_length=(480, 512, 544, 576, 608, 640, 672, 704, 736, 768, 800, 832, 864, 896, 928, 960), max_size=1333, sample_style="choice")),
                ("RandomFlip", dict()),
            ],
            TEST_PIPELINES=[
                ("ResizeShortestEdge", dict(
